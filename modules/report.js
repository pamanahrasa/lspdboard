 ...
 * one implementation behind both entry points. Import/Restore now write to
 * the SHARED Firestore database, visible to everyone - the copy here says
 * so explicitly rather than implying it's just local to this device.
 * ---------------------------------------------------------------------------
 */
